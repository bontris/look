									...
									<form class="nftmax-wc__form-main" action="{{url('/admin-login')}}" method="POST">
										...
										<div class="form-group">
											...
											<div class="form-group__input">
												...
												<input class="nftmax-wc__form-input" type="email" name="email" placeholder="empresa@gmail.com">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<div class="nftmax-wc__check-inline">
												...
												<div class="nftmax-wc__forgot">
													<a href="{{url('/forgot-password')}}" class="forgot-pass">Olvidó su contraseña?</a>
												</div>
											</div>
										</div>
										<div class="form-group">

        ...
        <div class="nftmax-body">
            ...
            <div class="nftmax-dsinner" v-if="same(view, 1)">
                <div class="nftmax-inner__heading">
                    <h2 class="nftmax-inner__page-title">Listado de compañías</h2>
                </div>
                <div class="nftmax-table mg-top-40">
                    <div class="nftmax-table__heading">
						<h3 class="nftmax-table__title mb-0">
                            Compañías <span class="nftmax-table__badge">@{{text(data.size)}}</span>
                        </h3>
                                ...
                                <tbody class="nftmax-table__body">
                                    <tr v-for="item in data.list">
                                        ...
                                        <td class="nftmax-table__column-7 nftmax-table__data-7">
                                            <div class="nftmax-table__status" :class="{1: 'nftmax-gbcolor', 2: 'nftmax-rbcolor', 3: 'nftmax-bbcolor'}[item.type]">@{{{1: 'Pública', 2: 'Privada', 3: 'Mixta'}[item.type]}}</div>
                                        </td>
                                        <td class="nftmax-table__column-7 nftmax-table__data-7">
                                            <div class="nftmax-table__status px-3" :class="item.lock ? 'nftmax-rbcolor' : 'nftmax-gbcolor'">@{{(item.lock ? 'Inactiva' : 'Activa')}}</div>
                                        </td>
                                        <td>
            ...
            <div class="nftmax-dsinner" v-if="same(view, 2)">
                <div class="nftmax-inner__heading">
                    <h2 class="nftmax-inner__page-title">@{{(pick ? 'Actualizar compañía' : 'Crear nueva compañía')}}</h2>
                </div>
                ...
                <div class="modal-dialog  nftmax-close__modal-close">
                    <div class="modal-content nftmax-preview__modal-content">
                        ...
                        <div class="modal-body nftmax-modal__body modal-body nftmax-close__body">
                            <div class="nftmax-preview__close">
                                <div class="nftmax-preview__close-img"><img src="assets/img/close.png" alt="#"></div>
                                <h2 class="nftmax-preview__close-title">@{{(pick ? '¿Desea actualizar la compañia?' : '¿Desea crear la nueva compañia?')}}</h2>
                                <div class="nftmax__item-button--group">
                ...
                <div class="modal-dialog  nftmax-close__modal-close">
                    <div class="modal-content nftmax-preview__modal-content">
                        ...
                        <div class="modal-body nftmax-modal__body modal-body nftmax-close__body">
                            <div class="nftmax-preview__close">
                                <div class="nftmax-preview__close-img"><img src="assets/img/close.png" alt="#"></div>
                                <h2 class="nftmax-preview__close-title">¿Desea eliminar la compañía?</h2>
                                <div class="nftmax__item-button--group">
  		...
  		Vue.ready(function () {
  			var self = new Vue({
			    ...
			    methods: {
                    ...
                    drop: function (item) {
			    		axios.get(`{{route('firms', ['task' => 'drop'])}}/${item.hash}`, {})
				             .then(function (data) {
                            $('#drop').modal('hide');
                            self.wait = false;

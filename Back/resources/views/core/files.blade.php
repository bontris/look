        ...
        <div class="nftmax-body">
            ...
            <div class="nftmax-dsinner" v-if="same(view, 1)">
                <div class="nftmax-inner__heading">
                    <h2 class="nftmax-inner__page-title">Listado de documentos</h2>
                </div>
                <div class="nftmax-table mg-top-40">
                    <div class="nftmax-table__heading">
						<h3 class="nftmax-table__title mb-0">
                            Documentos <span class="nftmax-table__badge">@{{text(data.length)}}</span>
                        </h3>
                                ...
                                <tbody class="nftmax-table__body">
                                    <tr v-for="item in data">
                                        ...
                                        <td class="nftmax-table__column-6">
                                            <a :href="`{{route('files', ['task' => 'save'])}}/${item.item}`" class="nftmax-sidebar__button-btn nftmax-request_request" target="_blank"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5,20H19V18H5M19,9H15V3H9V9H5L12,16L19,9Z" fill="white"></path></svg></a>
                                        </td>
                                    </tr>
                                </tbody>
            ...
            <div class="nftmax-dsinner" v-if="same(view, 2)">
                <div class="nftmax-inner__heading">
                    <h2 class="nftmax-inner__page-title">Subir documento</h2>
                </div>

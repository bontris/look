        ...
        <div class="nftmax-body">
            ...
            <div class="nftmax-dsinner" v-if="same(view, 1)">
                <div class="nftmax-inner__heading">
                    <h2 class="nftmax-inner__page-title">Listado de Validaciones de Representantes</h2>
                </div>
                <div class="nftmax-table mg-top-40">
                    <div class="nftmax-table__heading">
						<h3 class="nftmax-table__title mb-0">
                        Validaciones de Representantes <span class="nftmax-table__badge">@{{text(data.size)}}</span>
                        </h3>
                            ...
                            <table id="nftmax-table__main" class="nftmax-table__main nftmax-table__main-v1">
                                ...
                                <tbody class="nftmax-table__body">
                                    <tr>
                                        ...
                                        <td style="text-align: left">
                                            @{{pick?.data?.identificacion ?? 'Ninguno'}}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: left; vertical-align: top">
                                        ...
                                        <td style="text-align: left">
                                            @{{pick?.data?.razon_social ?? 'Ninguna'}}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: left; vertical-align: top">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left">
                                            @{{pick?.data?.categoria_matricula ?? 'Ninguna'}}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: left; vertical-align: top">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left">
                                            <div v-html="(pick?.data?.detalleRM ?? 'Ninguno')" />
                                        </td>
                                    </tr>
                                </tbody>
                                <!-- End NFTMax Table Body -->
                            ...
                            <div class="nftmax-preview__close" v-else>
                                <div style="width: 100%; overflow: hidden">
                                    ...
                                    <div class="nftmax__item-form--group">
                                        <input class="nftmax__item-input" style="width: 100%" type="text" placeholder="Número de identificación tributaria" v-model="card" required>
  			...
  			var self = new Vue({
			    ...
			    methods: {
			    	load: function (take, page, text, done) {
			    		axios.get("{{route('pasts', ['type' => 'representantes', 'task' => 'load'])}}?take=" + (take ?? '') + '&page=' + (page ?? '') +
			    			                                                                                                   '&find=' + (text ?? ''), {})
				             .then(function (data) {
			    	...
			    	post: function (card) {
                        ...
                        axios.post("{{route('pasts', ['type' => 'representantes', 'task' => 'post'])}}", data, {headers: {'X-CSRF-TOKEN': '{{csrf_token()}}'}})
	                             .then(function (data) {
                            $('#post').modal('hide');
                    ...
                    drop: function (item) {
			    		axios.get(`{{route('pasts', ['type' => 'representantes', 'task' => 'drop'])}}/${item.hash}`, {})
				             .then(function (data) {
                            $('#drop').modal('hide');
                            self.wait = false;

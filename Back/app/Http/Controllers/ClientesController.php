...
class ClientesController extends Controller
{
    public function index()
    {
        ...
        $AllNFTSUpdate = array(
            ['assets/img/nft-table-img1.png','Nombre Empresa 1',' Juan 1','Pago x Servicio','30.5 Horas','---',0],
            ['assets/img/nft-table-img1.png','Nombre Empresa 2',' Juan 2','Fee Mensual','3.5 Horas','6 Horas',0],
            ['assets/img/nft-table-img1.png','Nombre Empresa 3',' Juan 3','Fee Ilimitado','32.5 Horas','∞',1],
            ['assets/img/nft-table-img1.png','Nombre Empresa 7',' Juan 7','Fee Ilimitado','32.5 Horas','∞',0],
            ['assets/img/nft-table-img1.png','Nombre Empresa 4',' Juan 4','Bolsa de Horas','18 Horas','200 Horas',0],
            ['assets/img/nft-table-img1.png','Nombre Empresa 5',' Juan 5','Pago x Servicio','30.5 Horas','---',1],
            ['assets/img/nft-table-img1.png','Nombre Empresa 6',' Juan 6','Fee Mensual','3.5 Horas','6 Horas',0],
            ['assets/img/nft-table-img1.png','Nombre Empresa 8',' Juan 8','Bolsa de Horas','18 Horas','200 Horas',0]
        );
       ...
       // dd($HistoryData['Total_sell']);
        return view('Clientes',['AllNFTSUpdateV2'=>$AllNFTSUpdateV2,'AllNFTSUpdateV3'=>$AllNFTSUpdateV3,'MarketHistory_30days'=>$MarketHistory_30days,'MarketHistory_7days'=>$MarketHistory_7days,'SellHistory'=>$SellHistory,'MarketVisitor_7days'=>$MarketVisitor_7days,'MarketVisitor_30days'=>$MarketVisitor_30days,'MarketVisitor'=>$MarketVisitor,'MarketHistory'=>$MarketHistory,'AllNFTSUpdate'=>$AllNFTSUpdate,'HistoryData'=>$HistoryData,'Total_sell'=>$Total_sell,'ActiveCustomer'=>$ActiveCustomer,'Total_Prodcuts'=>$Total_Prodcuts,'Close_Offer'=>$Close_Offer]);
    }
}
